...
nix run github:capex122/hermes-agent -- setup
nix run github:capex122/hermes-agent -- chat

# Or install persistently
nix profile install github:capex122/hermes-agent
hermes setup
hermes chat
```
...
# /etc/nixos/flake.nix (or your system flake)
{
  inputs = {
    ...
    hermes-agent.url = "github:capex122/hermes-agent";
  };
