...
def build_search_intent_guidance(
    ...
    return (
        ...
        "browser_navigate to go directly to the first URL in the 'fallback_urls' list "
        "returned in the browser_search failure response. The 'required_next_action' field "
        "in the failure response tells you exactly which URL to navigate to next. "
