...
def build_search_intent_guidance(
    ...
    return (
        ...
        "- If browser_search fails for all engines (bot-blocked or no results), use "
        "browser_navigate to go directly to a well-known authoritative website that would "
        "have the answer. For sports results: flashscore.com, livescore.com, bbc.com/sport. "
        "For news: bbc.com/news, reuters.com. Do NOT give up after a failed browser_search "
        "— the next_step_hint in the error result tells you exactly what to do.\n"
