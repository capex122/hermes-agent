...
Built for [Hermes Agent](https://github.com/capex122/hermes-agent). Usable in any coding agent. Canonical source lives here; synced to [`capex122/hermes-agent/skills/creative/ascii-video`](https://github.com/capex122/hermes-agent/tree/main/skills/creative/ascii-video) via PR.
